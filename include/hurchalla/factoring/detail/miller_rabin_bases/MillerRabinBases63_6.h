...
#ifndef HURCHALLA_FACTORING_MILLER_RABIN_BASES63_6_H_INCLUDED
#define HURCHALLA_FACTORING_MILLER_RABIN_BASES63_6_H_INCLUDED
...
// This 16 byte hash table lets you determine the primality of any unsigned int
// number less than (1<<63), via miller-rabin primality testing using 6 bases.
...
struct MillerRabinBases<63, 6, DUMMY> {
...
public:
    ...
    std::array<std::uint16_t, 6> get(std::uint64_t num)
    {
        ...
        bases[3] = 28717;
        bases[4] = 734;
        constexpr std::uint16_t table[] = { 179, 10145, 11285, 12410,
                                            11714, 55967, 7103, 11827,
                                            5110, 17774, 54183, 44061,
                                            505, 15241, 3877, 873 };
        static_assert(sizeof(table)/sizeof(table[0]) == 16, "");
        uint32_t hash_bucket = static_cast<uint32_t>(num) >> 28;
