...
#else
#  define HURCHALLA_POLLARD_RHO_BRENT_GCD_THRESHOLD HURCHALLA_PRB_GCD_THRESHOLD
#endif
#ifndef HURCHALLA_PRB_STARTING_LENGTH
#  define HURCHALLA_POLLARD_RHO_BRENT_STARTING_LENGTH 19
#else
#  define HURCHALLA_POLLARD_RHO_BRENT_STARTING_LENGTH HURCHALLA_PRB_STARTING_LENGTH
#endif
